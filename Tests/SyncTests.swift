...
class SyncTests: XCTestCase {
  ...
  func testAutomaticCamelcaseMapping() {
    let dataStack = Helper.dataStack("Camelcase")
  ...
  func testLoadAndUpdateUsers() {
    let dataStack = Helper.dataStack("Contacts")
    ...
    let result = Helper.fetchEntity("User", predicate: Predicate(format: "remoteID = %@", NSNumber(value: 7)), sortDescriptors: [SortDescriptor(key: "remoteID", ascending: true)], inContext: dataStack.mainContext).first!
    XCTAssertEqual(result.value(forKey: "email") as? String, "secondupdated@ovium.com")

    let dateFormat = DateFormatter()
    dateFormat.dateFormat = "yyyy-MM-dd"
    dateFormat.timeZone = TimeZone(name: "GMT")

    let createdDate = dateFormat.date(from: "2014-02-14")
    XCTAssertEqual(result.value(forKey: "createdAt") as? NSDate, createdDate);

    let updatedDate = dateFormat.date(from: "2014-02-17")
    XCTAssertEqual(result.value(forKey: "updatedAt") as? NSDate, updatedDate)
  ...
  func testUsersAndCompanies() {
    ...
    let user = Helper.fetchEntity("User", predicate: Predicate(format: "remoteID = %@", NSNumber(value: 0)), sortDescriptors: [SortDescriptor(key: "remoteID", ascending: true)], inContext:dataStack.mainContext).first!
    ...
    let company = Helper.fetchEntity("Company", predicate: Predicate(format: "remoteID = %@", NSNumber(value: 1)), sortDescriptors: [SortDescriptor(key: "remoteID", ascending: true)], inContext:dataStack.mainContext).first!
  ...
  func testCustomMappingAndCustomPrimaryKey() {
    ...
    let array = Helper.fetchEntity("Image", sortDescriptors: [SortDescriptor(key: "url", ascending: true)], inContext: dataStack.mainContext)
  ...
  func testRelationshipsB() {
    ...
    let users = Helper.fetchEntity("User", predicate: Predicate(format: "remoteID = %@", NSNumber(value: 6)), inContext:dataStack.mainContext)
    ...
    let profilePicturesCount = Helper.count("Image", predicate: Predicate(format: "user = %@", user), inContext:dataStack.mainContext)
  ...
  func testSyncingWithOnlyInsertOperationType() {
    ...
    let result = Helper.fetchEntity("User", predicate: Predicate(format: "remoteID = %@", NSNumber(value: 0)), sortDescriptors: [SortDescriptor(key: "remoteID", ascending: true)], inContext: dataStack.mainContext).first!
  ...
  func testSyncingWithInsertAndUpdateOperationType() {
    ...
    let user0 = Helper.fetchEntity("User", predicate: Predicate(format: "remoteID = %@", NSNumber(value: 0)), sortDescriptors: [SortDescriptor(key: "remoteID", ascending: true)], inContext: dataStack.mainContext).first!
    XCTAssertEqual(user0.value(forKey: "email") as? String, "updated@ovium.com")

    let user1 = Helper.fetchEntity("User", predicate: Predicate(format: "remoteID = %@", NSNumber(value: 1)), sortDescriptors: [SortDescriptor(key: "remoteID", ascending: true)], inContext: dataStack.mainContext).first!
  ...
  func testRelationshipsA() {
    ...
    let dataStack = Helper.dataStack("Notes")
    ...
    let users = Helper.fetchEntity("SuperUser", predicate: Predicate(format:"remoteID = %@", NSNumber(value: 6)), inContext:dataStack.mainContext)
    let user = users.first!
    XCTAssertEqual(user.value(forKey: "name") as? String, "Shawn Merrill")

    let notesCount = Helper.count("SuperNote", predicate: Predicate(format:"superUser = %@", user), inContext:dataStack.mainContext)
  ...
  func testObjectsForParent() {
    ...
    var users = Helper.fetchEntity("SuperUser", predicate: Predicate(format:"remoteID = %@", NSNumber(value: 6)), inContext:dataStack.mainContext)
    ...
    users = Helper.fetchEntity("SuperUser", predicate: Predicate(format:"remoteID = %@", NSNumber(value: 6)), inContext: dataStack.mainContext)
    let user = users.first!
    XCTAssertEqual(user.value(forKey: "name") as? String, "Shawn Merrill")
  ...
  func testTaggedNotesForUser() {
    ...
    let notes = Helper.fetchEntity("SuperNote", predicate: Predicate(format:"remoteID = %@", NSNumber(value: 0)), inContext:dataStack.mainContext)
    ...
    let tags = Helper.fetchEntity("SuperTag", predicate: Predicate(format:"remoteID = %@", NSNumber(value: 1)), inContext:dataStack.mainContext)
  ...
  func testNumbersWithEmptyRelationship() {
    ...
    let dataStack = Helper.dataStack("Recursive")
  ...
  func testCustomPrimaryKey() {
    ...
    let dataStack = Helper.dataStack("Social")
    ...
    let comments = Helper.fetchEntity("SocialComment", predicate: Predicate(format:"body = %@", "comment 1"), inContext:dataStack.mainContext)
  ...
  func testCustomPrimaryKeyInsideToManyRelationship() {
    ...
    let stories = Helper.fetchEntity("Story", predicate: Predicate(format:"remoteID = %@", NSNumber(value: 0)), inContext:dataStack.mainContext)
    ...
    var comments = Helper.fetchEntity("SocialComment", predicate: Predicate(format:"body = %@", "comment 1"), inContext:dataStack.mainContext)
    XCTAssertEqual(comments.count, 3)

    comments = Helper.fetchEntity("SocialComment", predicate: Predicate(format:"body = %@ AND story = %@", "comment 1", story), inContext:dataStack.mainContext)
    XCTAssertEqual(comments.count, 1)
    let comment = comments.first!
    XCTAssertEqual(comment.value(forKey: "body") as? String, "comment 1")
  ...
  func testMarketsAndItems() {
    ...
    let dataStack = Helper.dataStack("Markets")
    ...
    let markets = Helper.fetchEntity("Market", predicate: Predicate(format:"uniqueId = %@", "1"), inContext:dataStack.mainContext)
    ...
    let items = Helper.fetchEntity("Item", predicate: Predicate(format:"uniqueId = %@", "1"), inContext:dataStack.mainContext)
  ...
  func testOrganization() {
    ...
    let dataStack = Helper.dataStack("Organizations")
  ...
  */
  func testUniqueObject() {
    ...
    let dataStack = Helper.dataStack("Unique")
  ...
  func testPatients() {
    ...
    let dataStack = Helper.dataStack("Patients")
  ...
  func testStaffAndfulfillers() {
    ...
    let dataStack = Helper.dataStack("Bug84")
    ...
    let staff = Helper.fetchEntity("MSStaff", predicate: Predicate(format:"xid = %@", "mstaff_F58dVBTsXznvMpCPmpQgyV"), inContext:dataStack.mainContext)
    ...
    let fulfillers = Helper.fetchEntity("MSFulfiller", predicate: Predicate(format:"xid = %@", "ffr_AkAHQegYkrobp5xc2ySc5D"), inContext:dataStack.mainContext)
  ...
  func testCustomPrimaryKeyBug113() {
    ...
    let dataStack = Helper.dataStack("Bug113")
    ...
    let comments = Helper.fetchEntity("AwesomeComment", predicate: Predicate(format:"body = %@", "comment 1"), inContext:dataStack.mainContext)
    XCTAssertEqual(comments.count, 1)
  ...
  func testCustomPrimaryKeyInsideToManyRelationshipBug113() {
    ...
    let stories = Helper.fetchEntity("AwesomeStory", predicate: Predicate(format:"remoteID = %@", NSNumber(value: 0)), inContext:dataStack.mainContext)
    let story = stories.first!
    ...
    var comments = Helper.fetchEntity("AwesomeComment", predicate: Predicate(format:"body = %@", "comment 1"), inContext:dataStack.mainContext)
    XCTAssertEqual(comments.count, 3)

    comments = Helper.fetchEntity("AwesomeComment", predicate: Predicate(format:"body = %@ AND awesomeStory = %@", "comment 1", story), inContext: dataStack.mainContext)
    XCTAssertEqual(comments.count, 1)
    let comment = comments.first!
    XCTAssertEqual(comment.value(forKey: "body") as? String, "comment 1")
    XCTAssertEqual(comment.value(forKey: "awesomeStory")!.value(forKey: "remoteID") as? NSNumber, NSNumber(value: 0))
    XCTAssertEqual(comment.value(forKey: "awesomeStory")!.value(forKey: "title") as? String, "story 1")
  ...
  func testNilRelationshipsAfterUpdating_Sync_1_0_10() {
    ...
    Sync.changes([formDictionary], inEntityNamed:"Form", predicate: Predicate(format: "uri == %@", uri), dataStack:dataStack, completion:nil)
  ...
  func testStoryToSummarize() {
    ...
    Sync.changes([formDictionary], inEntityNamed:"Story", predicate: Predicate(format:"remoteID == %@", NSNumber(value: 1)), dataStack:dataStack, completion:nil)

    XCTAssertEqual(Helper.countForEntity("Story", inContext:dataStack.mainContext), 1)
    let stories = Helper.fetchEntity("Story", predicate: Predicate(format:"remoteID = %@", NSNumber(value: 1)), inContext:dataStack.mainContext)
    let story = stories.first!
    ...
    let comments = Helper.fetchEntity("SocialComment", predicate: Predicate(format:"body = %@", "Hi"), inContext:dataStack.mainContext)
    XCTAssertEqual(comments.count, 1)
  ...
  func testIDRelationshipMapping() {
    ...
    XCTAssertEqual(user.value(forKey: "name") as? String, "Melisa White")
  ...
  func testIDRelationshipCustomMapping() {
    let usersDictionary = Helper.objectsFromJSON("users_a.json") as! [[String : AnyObject]]
    let dataStack = Helper.dataStack("NotesB")
    ...
    let notes = Helper.fetchEntity("SuperNoteB", predicate: Predicate(format:"remoteID = %@", NSNumber(value: 0)), inContext:dataStack.mainContext)
    let note = notes.first!
    let user = note.value(forKey: "superUser")!
    XCTAssertEqual(user.value(forKey: "name") as? String, "Melisa White")
  ...
  func testCustomPrimaryKeyInOrderedRelationship() {
    let objects = Helper.objectsFromJSON("comments-no-id.json") as! [[String : AnyObject]]
    let dataStack = Helper.dataStack("OrderedSocial")
    ...
    let comments = Helper.fetchEntity("Comment", predicate: Predicate(format:"body = %@", "comment 1"), inContext:dataStack.mainContext)
    XCTAssertEqual(comments.count, 1)
    XCTAssertEqual((comments.first!.value(forKey: "comments") as! OrderedSet).count, 3)
  ...
  func testConnectMultipleRelationships() {
    ...
    let dataStack = Helper.dataStack("Bug179")
  ...
  func testManyToManyKeyNotAllowedHere() {
    let dataStack = Helper.dataStack("Bug202")
  ...
  func testIDAsRemoteID() {
    let dataStack = Helper.dataStack("id")
  ...
  func testBug157() {
    let dataStack = Helper.dataStack("Bug157")
    ...
    Sync.changes(locations, inEntityNamed: "Location", dataStack: dataStack, completion: nil)
    var location1 = Helper.fetchEntity("Location", predicate: Predicate(format: "locationID = 0"), inContext: dataStack.mainContext).first
    ...
    var location2 = Helper.fetchEntity("Location", predicate: Predicate(format: "locationID = 1"), inContext: dataStack.mainContext).first
    ...
    var location3 = Helper.fetchEntity("Location", predicate: Predicate(format: "locationID = 2"), inContext: dataStack.mainContext).first
    ...
    location1 = Helper.fetchEntity("Location", predicate: Predicate(format: "locationID = 0"), inContext: dataStack.mainContext).first
    location1City = location1?.value(forKey: "city") as? NSManagedObject
    XCTAssertNil(location1City?.value(forKey: "name") as? String)
    location2 = Helper.fetchEntity("Location", predicate: Predicate(format: "locationID = 1"), inContext: dataStack.mainContext).first
    ...
    location3 = Helper.fetchEntity("Location", predicate: Predicate(format: "locationID = 2"), inContext: dataStack.mainContext).first
  ...
  func testMultipleIDRelationshipToMany() {
    let dataStack = Helper.dataStack("151-to-many")
    ...
    XCTAssertEqual(Helper.countForEntity("User", inContext:dataStack.mainContext), 3)
    XCTAssertEqual(Helper.countForEntity("Note", inContext:dataStack.mainContext), 3)
    var user10 = Helper.fetchEntity("User", predicate: Predicate(format: "userID = 10"), inContext: dataStack.mainContext).first
    var user10Notes = user10?.value(forKey: "notes") as? Set<NSManagedObject>
    XCTAssertEqual(user10Notes?.count, 2)
    var user11 = Helper.fetchEntity("User", predicate: Predicate(format: "userID = 11"), inContext: dataStack.mainContext).first
    var user11Notes = user11?.value(forKey: "notes") as? Set<NSManagedObject>
    XCTAssertEqual(user11Notes?.count, 1)
    var user12 = Helper.fetchEntity("User", predicate: Predicate(format: "userID = 12"), inContext: dataStack.mainContext).first
    var user12Notes = user12?.value(forKey: "notes") as? Set<NSManagedObject>
    XCTAssertEqual(user12Notes?.count, 0)
    var note0 = Helper.fetchEntity("Note", predicate: Predicate(format: "noteID = 0"), inContext: dataStack.mainContext).first
    var note0User = note0?.value(forKey: "user") as? NSManagedObject
    XCTAssertEqual(note0User?.value(forKey: "userID") as? Int, 10)
    var note1 = Helper.fetchEntity("Note", predicate: Predicate(format: "noteID = 1"), inContext: dataStack.mainContext).first
    var note1User = note1?.value(forKey: "user") as? NSManagedObject
    XCTAssertEqual(note1User?.value(forKey: "userID") as? Int, 10)
    var note2 = Helper.fetchEntity("Note", predicate: Predicate(format: "noteID = 2"), inContext: dataStack.mainContext).first
    ...
    XCTAssertEqual(Helper.countForEntity("User", inContext:dataStack.mainContext), 3)
    XCTAssertEqual(Helper.countForEntity("Note", inContext:dataStack.mainContext), 3)
    user10 = Helper.fetchEntity("User", predicate: Predicate(format: "userID = 10"), inContext: dataStack.mainContext).first
    user10Notes = user10?.value(forKey: "notes") as? Set<NSManagedObject>
    XCTAssertEqual(user10Notes?.count, 0)
    user11 = Helper.fetchEntity("User", predicate: Predicate(format: "userID = 11"), inContext: dataStack.mainContext).first
    user11Notes = user11?.value(forKey: "notes") as? Set<NSManagedObject>
    XCTAssertEqual(user11Notes?.count, 1)
    user12 = Helper.fetchEntity("User", predicate: Predicate(format: "userID = 12"), inContext: dataStack.mainContext).first
    user12Notes = user12?.value(forKey: "notes") as? Set<NSManagedObject>
    XCTAssertEqual(user12Notes?.count, 2)
    note0 = Helper.fetchEntity("Note", predicate: Predicate(format: "noteID = 0"), inContext: dataStack.mainContext).first
    note0User = note0?.value(forKey: "user") as? NSManagedObject
    XCTAssertEqual(note0User?.value(forKey: "userID") as? Int, 12)
    note1 = Helper.fetchEntity("Note", predicate: Predicate(format: "noteID = 1"), inContext: dataStack.mainContext).first
    note1User = note1?.value(forKey: "user") as? NSManagedObject
    XCTAssertEqual(note1User?.value(forKey: "userID") as? Int, 12)
    note2 = Helper.fetchEntity("Note", predicate: Predicate(format: "noteID = 2"), inContext: dataStack.mainContext).first
  ...
  func testOrderedMultipleIDRelationshipToMany() {
    let dataStack = Helper.dataStack("151-ordered-to-many")
    ...
    XCTAssertEqual(Helper.countForEntity("User", inContext:dataStack.mainContext), 3)
    XCTAssertEqual(Helper.countForEntity("Note", inContext:dataStack.mainContext), 3)
    var user10 = Helper.fetchEntity("User", predicate: Predicate(format: "id = 10"), inContext: dataStack.mainContext).first
    var user10Notes = user10?.value(forKey: "notes") as? OrderedSet
    XCTAssertEqual(user10Notes?.set.count, 2)
    var user11 = Helper.fetchEntity("User", predicate: Predicate(format: "id = 11"), inContext: dataStack.mainContext).first
    var user11Notes = user11?.value(forKey: "notes") as? OrderedSet
    XCTAssertEqual(user11Notes?.set.count, 1)
    var user12 = Helper.fetchEntity("User", predicate: Predicate(format: "id = 12"), inContext: dataStack.mainContext).first
    var user12Notes = user12?.value(forKey: "notes") as? OrderedSet
    ...
    XCTAssertEqual(Helper.countForEntity("User", inContext:dataStack.mainContext), 3)
    XCTAssertEqual(Helper.countForEntity("Note", inContext:dataStack.mainContext), 3)
    user10 = Helper.fetchEntity("User", predicate: Predicate(format: "id = 10"), inContext: dataStack.mainContext).first
    user10Notes = user10?.value(forKey: "notes") as? OrderedSet
    XCTAssertEqual(user10Notes?.set.count, 0)
    user11 = Helper.fetchEntity("User", predicate: Predicate(format: "id = 11"), inContext: dataStack.mainContext).first
    user11Notes = user11?.value(forKey: "notes") as? OrderedSet
    XCTAssertEqual(user11Notes?.set.count, 1)
    user12 = Helper.fetchEntity("User", predicate: Predicate(format: "id = 12"), inContext: dataStack.mainContext).first
    user12Notes = user12?.value(forKey: "notes") as? OrderedSet
  ...
  func testMultipleIDRelationshipManyToMany() {
    let dataStack = Helper.dataStack("151-many-to-many")
    ...
    var note3 = Helper.fetchEntity("Note", predicate: Predicate(format: "noteID = 3"), inContext: dataStack.mainContext).first
    ...
    note3 = Helper.fetchEntity("Note", predicate: Predicate(format: "noteID = 3"), inContext: dataStack.mainContext).first
  ...
  func testOrderedMultipleIDRelationshipManyToMany() {
    let dataStack = Helper.dataStack("151-ordered-many-to-many")
    ...
    XCTAssertEqual(Helper.countForEntity("Note", inContext:dataStack.mainContext), 4)
    XCTAssertEqual(Helper.countForEntity("Tag", inContext:dataStack.mainContext), 2)
    var note0 = Helper.fetchEntity("Note", predicate: Predicate(format: "id = 0"), inContext: dataStack.mainContext).first
    var note0Tags = note0?.value(forKey: "tags") as? OrderedSet
    XCTAssertEqual(note0Tags?.count, 2)
    var note1 = Helper.fetchEntity("Note", predicate: Predicate(format: "id = 1"), inContext: dataStack.mainContext).first
    var note1Tags = note1?.value(forKey: "tags") as? OrderedSet
    XCTAssertEqual(note1Tags?.count, 1)
    var note2 = Helper.fetchEntity("Note", predicate: Predicate(format: "id = 2"), inContext: dataStack.mainContext).first
    var note2Tags = note2?.value(forKey: "tags") as? OrderedSet
    XCTAssertEqual(note2Tags?.count, 0)
    var note3 = Helper.fetchEntity("Note", predicate: Predicate(format: "id = 3"), inContext: dataStack.mainContext).first
    var note3Tags = note3?.value(forKey: "tags") as? OrderedSet
    XCTAssertEqual(note3Tags?.count, 1)
    ...
    XCTAssertEqual(Helper.countForEntity("Tag", inContext:dataStack.mainContext), 2)
    Sync.changes(updatedNotes, inEntityNamed: "Note", dataStack: dataStack, completion: nil)
    note0 = Helper.fetchEntity("Note", predicate: Predicate(format: "id = 0"), inContext: dataStack.mainContext).first
    note0Tags = note0?.value(forKey: "tags") as? OrderedSet
    XCTAssertEqual(note0Tags?.set.count, 1)
    note1 = Helper.fetchEntity("Note", predicate: Predicate(format: "id = 1"), inContext: dataStack.mainContext).first
    note1Tags = note1?.value(forKey: "tags") as? OrderedSet
    XCTAssertEqual(note1Tags?.set.count, 0)
    note2 = Helper.fetchEntity("Note", predicate: Predicate(format: "id = 2"), inContext: dataStack.mainContext).first
    note2Tags = note2?.value(forKey: "tags") as? OrderedSet
    XCTAssertEqual(note2Tags?.set.count, 2)
    note3 = Helper.fetchEntity("Note", predicate: Predicate(format: "id = 3"), inContext: dataStack.mainContext).first
    note3Tags = note3?.value(forKey: "tags") as? OrderedSet
    XCTAssertEqual(note3Tags?.count, 0)
