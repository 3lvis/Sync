...
class SyncTests: XCTestCase {
    ...
    func testBug239() {
        let carsObject = Helper.objectsFromJSON("bug-239-cars.json") as! [[String : AnyObject]]
        ...
        let passengersObject = Helper.objectsFromJSON("bug-239-passengers.json") as! [[String : AnyObject]]
