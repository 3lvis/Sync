...
@objc public class Sync: NSOperation {
    ...
    public class func changes(changes: [[String : AnyObject]], inEntityNamed entityName: String, predicate: NSPredicate?, dataStack: DATAStack, completion: ((error: NSError?) -> Void)?) {
        dataStack.performInNewBackgroundContext { backgroundContext in
            self.changes(changes, inEntityNamed: entityName, predicate: predicate, remoteIDs: nil, parent: nil, parentRelationship: nil, inContext: backgroundContext, dataStack: dataStack, operations: .All, completion: completion)
        }
    }
    ...
    public class func changes(changes: [[String : AnyObject]], inEntityNamed entityName: String, predicate: NSPredicate?, dataStack: DATAStack, operations: DATAFilter.Operation, completion: ((error: NSError?) -> Void)?) {
        dataStack.performInNewBackgroundContext { backgroundContext in
            self.changes(changes, inEntityNamed: entityName, predicate: predicate, remoteIDs: nil, parent: nil, parentRelationship: nil, inContext: backgroundContext, dataStack: dataStack, operations: operations, completion: completion)
        }
    }
    ...
    public class func changes(changes: [[String : AnyObject]], inEntityNamed entityName: String, parent: NSManagedObject, dataStack: DATAStack, completion: ((error: NSError?) -> Void)?) {
        dataStack.performInNewBackgroundContext { backgroundContext in
            ...
            self.changes(changes, inEntityNamed: entityName, predicate: predicate, remoteIDs: nil, parent: safeParent, parentRelationship: nil, inContext: backgroundContext, dataStack: dataStack, operations: .All, completion: completion)
        }
    }
    ...
    public class func changes(changes: [[String : AnyObject]], inEntityNamed entityName: String, predicate: NSPredicate?, parent: NSManagedObject?, inContext context: NSManagedObjectContext, dataStack: DATAStack, completion: ((error: NSError?) -> Void)?) {
        self.changes(changes, inEntityNamed: entityName, predicate: predicate, remoteIDs: nil, parent: parent, parentRelationship: nil, inContext: context, dataStack: dataStack, operations: .All, completion: completion)
    }

    public class func changes(changes: [[String : AnyObject]], inEntityNamed entityName: String, predicate: NSPredicate?, remoteIDs: AnyObject?, parent: NSManagedObject?, parentRelationship: NSRelationshipDescription?, inContext context: NSManagedObjectContext, dataStack: DATAStack, operations: DATAFilter.Operation, completion: ((error: NSError?) -> Void)?) {
        ...
        DATAFilter.changes(changes as [[String: AnyObject]], inEntityNamed: entityName, predicate: finalPredicate, operations: operations, localPrimaryKey: localPrimaryKey, remotePrimaryKey: remotePrimaryKey, context: context, inserted: { JSON in
            ...
            created.sync_fillWithDictionary(JSON, remoteIDs: remoteIDs, parent: parent, parentRelationship: parentRelationship, dataStack: dataStack, operations: operations)
        }) { JSON, updatedObject in
            updatedObject.sync_fillWithDictionary(JSON, remoteIDs: remoteIDs, parent: parent, parentRelationship: parentRelationship, dataStack: dataStack, operations: operations)
        }
    ...
    func changes(changes: [[String : AnyObject]], inEntityNamed entityName: String, predicate: NSPredicate?, parent: NSManagedObject?, parentRelationship: NSRelationshipDescription?, inContext context: NSManagedObjectContext, dataStack: DATAStack, operations: DATAFilter.Operation, completion: ((error: NSError?) -> Void)?) {
        ...
        DATAFilter.changes(changes as [[String : AnyObject]], inEntityNamed: entityName, predicate: finalPredicate, operations: operations, localPrimaryKey: localPrimaryKey, remotePrimaryKey: remotePrimaryKey, context: context, inserted: { JSON in
            ...
            let created = NSEntityDescription.insertNewObjectForEntityForName(entityName, inManagedObjectContext: context)
            created.sync_fillWithDictionary(JSON, remoteIDs: nil, parent: parent, parentRelationship: parentRelationship, dataStack: dataStack, operations: operations)
        }) { JSON, updatedObject in
            guard self.cancelled == false else { return }
            updatedObject.sync_fillWithDictionary(JSON, remoteIDs: nil, parent: parent, parentRelationship: parentRelationship, dataStack: dataStack, operations: operations)
        }
